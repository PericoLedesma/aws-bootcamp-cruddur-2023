...
I've registered a domain name `mycruddurapp.com` for this bootcamp via [strato](https://www.strato.es). 
Task completed:
- managed the domain using Route53 via hosted zone
...
![Proof of work](assets/week6/route53.png)
